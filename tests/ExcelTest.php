...
use Chubb001\Excel31\Tests\Data\Stubs\EmptyExport;
...
class ExcelTest extends TestCase
{
    ...
    {
        $this->expectException(\Chubb001\Excel31\Exceptions\ConcernConflictException::class);
    ...
    {
        $this->expectException(\Chubb001\Excel31\Exceptions\NoTypeDetectedException::class);
